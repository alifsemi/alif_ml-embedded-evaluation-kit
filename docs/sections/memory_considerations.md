...
To use the other supported memory modes refer to [vela.ini](https://gitlab.arm.com/artificial-intelligence/ethos-u/ethos-u-vela/-/blob/4.4.1/ethosu/config_files/Arm/vela.ini).
