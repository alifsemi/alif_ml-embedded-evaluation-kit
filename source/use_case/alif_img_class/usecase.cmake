...
if (${ML_FRAMEWORK} STREQUAL "TensorFlowLiteMicro")
    ...
    set(LABELS_TXT_FILE ${CMAKE_CURRENT_SOURCE_DIR}/resources/img_class/labels/labels_mobilenet_v2_1.0_224.txt)
...
elseif(${ML_FRAMEWORK} STREQUAL "ExecuTorch")
    set(LABELS_TXT_FILE ${CMAKE_CURRENT_SOURCE_DIR}/resources/img_class/labels/labels_mobilenet_v2_1.IMAGENET1K_V2.txt)
