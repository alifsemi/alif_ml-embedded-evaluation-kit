...
#elif RTE_OV5640_CAMERA_SENSOR_LPCPI_ENABLE
#define CIMAGE_X                (RTE_OV5640_CAMERA_SENSOR_LPCPI_FRAME_WIDTH)
#define CIMAGE_Y                (RTE_OV5640_CAMERA_SENSOR_LPCPI_FRAME_HEIGHT)
#define CIMAGE_COLOR_CORRECTION (0)
#define CIMAGE_SW_GAIN_CONTROL  (0)
#define CIMAGE_USE_RGB565       (1)
#define CIMAGE_RGB_WIDTH_MAX    CIMAGE_X
