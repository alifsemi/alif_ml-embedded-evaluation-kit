...
{
    uint32_t utimer_mode:1;                          /**< SET: UTIMER(channel 0-11), CLEAR: QEC(channel 12-15) >*/
    uint32_t fixed_buffer:1;                         /**< Fixed buffer operation, SET: Enabled, CLEAR: Disabled >*/
    uint32_t buf_trough_n_crest:3;                   /**< configuring buffering for triangle timer at trough(0x4) or trough and crest(0x5) or fixed op(0x6) >*/
    ...
    uint32_t buffering_type:1;                       /**< Buffering type: SET: Single or CLEAR: Double >*/
    uint32_t buffer_operation:1;                     /**< Buffer opern for compare & DT modes: SET: Enabled or CLEAR: Disabled >*/
    ...
    uint32_t buffering_type_A:2;                     /**< Only for Capture mode: Buffering type for Drive A Single or Double>*/
    uint32_t buffering_type_B:2;                     /**< Only for Capture mode: Buffering type for Drive B Single or Double>*/
