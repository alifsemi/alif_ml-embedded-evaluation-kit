...
set(SRAM_RLATENCY   "16"       CACHE STRING "12-bit field. Minimum latency (clock cycles) from AVALID to RVALID.")
set(SRAM_WLATENCY   "16"       CACHE STRING "12-bit field. Minimum latency (clock cycles) from WVALID&WLAST to BVALID.")
...
set(SRAM_BWCAP      "4000"     CACHE STRING "16-bit field. Max no. of 128-bit words transfered per pulse cycle 0=infinite")
...
if (ETHOS_U_NPU_MEMORY_MODE STREQUAL Sram_Only)
    ...
    set(EXT_BWCAP       ${SRAM_BWCAP}        CACHE STRING "16-bit field. Max no. of 128-bit words transfered per pulse cycle 0=infinite")
    ...
    set(EXT_RLATENCY    "250"      CACHE STRING "12-bit field. Minimum latency (clock cycles) from AVALID to RVALID.")
    set(EXT_WLATENCY    "125"      CACHE STRING "12-bit field. Minimum latency (clock cycles) from WVALID&WLAST to BVALID.")
    ...
    set(EXT_BWCAP       "2344"     CACHE STRING "16-bit field. Max no. of 128-bit words transfered per pulse cycle 0=infinite")
