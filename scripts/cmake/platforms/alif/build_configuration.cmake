...
function(set_platform_global_defaults)
    ...
    set_property(CACHE ALIF_DEVICE_SKU PROPERTY STRINGS "AE1C1F4051920" "AE722F80F55D5" "AE822FA0E5597" "AE402FA0E5597")

    set(TARGET_BOARD "AppKit-e7" CACHE STRING "Board type")
    set_property(CACHE TARGET_BOARD PROPERTY STRINGS "AppKit-e7" "DevKit-e1c" "DevKit-e4" "DevKit-e7" "DevKit-e8" "AppKit-e8" "StartKit-e1c" "StartKit-b1")
    ...
    if (NOT ((TARGET_BOARD STREQUAL "AppKit-e7") OR (TARGET_BOARD STREQUAL "DevKit-e1c") OR (TARGET_BOARD STREQUAL "DevKit-e4") OR (TARGET_BOARD STREQUAL "DevKit-e7")
        OR (TARGET_BOARD STREQUAL "DevKit-e8") OR (TARGET_BOARD STREQUAL "AppKit-e8")  OR (TARGET_BOARD STREQUAL "StartKit-e1c") OR (TARGET_BOARD STREQUAL "StartKit-b1") ))
        message(FATAL_ERROR "Possible TARGET_BOARD values are: AppKit-e7, DevKit-e1c, DevKit-e4, DevKit-e7, DevKit-e8, StartKit-e1c, StartKit-b1 and AppKit-e8 but given value was ${TARGET_BOARD}")
    endif()
    ...
    if ((TARGET_BOARD STREQUAL "DevKit-e1c") OR (TARGET_BOARD STREQUAL "StartKit-e1c")  OR (TARGET_BOARD STREQUAL "StartKit-b1") ) # Add other Devkit and AppKits which are Balletto devices
