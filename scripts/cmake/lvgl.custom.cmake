...
# Remove renesas DAV/E 2D integration from build.
# We need to enable the Renesas specific LV_USE_DRAW_DAVE2D flag in order to
# get the lv_draw_dave2d_init() call in lv_init() but the rest of the DAV/E integration
# comes from alif_lvgl-dave2d submodule
foreach (SRC_FN ${SOURCES})
    string (FIND ${SRC_FN} "/renesas/" EXCLUDE_SRC)
    if (${EXCLUDE_SRC} GREATER -1)
        list (REMOVE_ITEM SOURCES ${SRC_FN})
    endif ()
endforeach(SRC_FN)
